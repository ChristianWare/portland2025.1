        ...
        <div className={styles.content}>
          <div className={styles.left}>
            ...
            <p className={styles.copy}>
              ...
              <br />
              <br />I have experience designing, coding, and deploying a variety
              of websites, from{" "}
              <span className={styles.span}>Landing Pages</span> to fully
              functional <span className={styles.span}>E-commerce Stores.</span>{" "}
              My personal website, chrisware.dev, reflects my attention to
